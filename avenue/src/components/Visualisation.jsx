...
const Visualisation = () => {
  ...
  const images = useMemo(() => {
    ...
    for (let i = 1; i <= 74; i++) {
      ...
      img.src = `/videos/ConceptVisualisation/ConceptVisualisation${num}.jpg`;
  ...
  const currentIndex = useTransform(scrollYProgress, [0, 1], [1, 74]);
  ...
  return (
    <div className="h-[2500px] mb-[250px]" ref={containerRef}> {/* Updated to add ref */}
      <div className="sticky top-[90px] w-full h-[65vh]">
        ...
        <a href="/work/uniiione" className='z-10'>
